    ...
    <div className="min-h-screen bg-[color:var(--page-bg)]">
      <div className="grid min-h-screen lg:grid-cols-[1.05fr_0.95fr]">
        <motion.section
          ...
          className="relative hidden overflow-hidden bg-[color:var(--brand-green)] text-white lg:flex"
        >
          <img
          ...
          <div className="relative flex w-full flex-col justify-between p-10 xl:p-14">
            ...
            <div className="max-w-xl">
              ...
              <motion.p
                ...
                className="mt-5 max-w-lg text-base leading-8 text-white/76"
              >
                {t('auth.secureAccess')}
              </motion.p>
            </div>
        ...
        <motion.section
          ...
          className="flex flex-col items-center justify-center px-4 py-10 sm:px-6 lg:px-10 lg:pt-10"
        >
          <Link
            to="/"
            state={{ postAuthSplash: true }}
          ...
          >
            <Card className="w-full rounded-[30px] border border-slate-200 bg-white shadow-[0_28px_70px_rgba(15,23,42,0.08)]">
