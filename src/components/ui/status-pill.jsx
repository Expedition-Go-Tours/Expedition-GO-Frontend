...
const TONE_STYLES = {
  ...
  danger: 'bg-[color:var(--admin-danger-soft)] text-[color:var(--admin-danger)] border-transparent',
  info: 'bg-[color:var(--admin-info-soft)] text-[color:var(--admin-info)] border-transparent',
  brand:
