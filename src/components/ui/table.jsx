...
function Table({ className, ...props }) {
  return (
    <div className="relative w-full overflow-x-auto">
      <table
        className={cn('w-full caption-bottom text-sm text-[color:var(--admin-text)]', className)}
        {...props}
      />
    </div>
  );
...
function TableHeader({ className, ...props }) {
  return (
    <thead
      className={cn('[&_tr]:border-b [&_tr]:border-[color:var(--admin-border)]', className)}
      {...props}
    />
  );
}
...
function TableCaption({ className, ...props }) {
  return (
    <caption className={cn('mt-3 text-xs text-[color:var(--admin-muted)]', className)} {...props} />
  );
}
