...
const SAMPLE_ARTICLES = [
  {
    ...
    excerpt:
      'Discover lesser-known destinations that will take your breath away, from secret waterfalls to ancient villages.',
  ...
  },
  {
    ...
    excerpt:
      "Learn about the rich history and cultural significance of one of Ghana's most important heritage sites.",
    category: 'Heritage',
    readTime: '8 min read',
    date: 'Jan 12, 2026',
  ...
  },
  {
    ...
    excerpt:
      "From jollof rice to kelewele, explore the vibrant street food scene in Ghana's capital city.",
  ...
  },
  {
    ...
    excerpt:
      'Everything you need to know before embarking on your African safari adventure, from packing to wildlife spotting.',
  ...
  },
  {
    ...
    excerpt:
      "Experience the thrill of the canopy walkway and discover the biodiversity of Ghana's tropical rainforest.",
    category: 'Nature',
    readTime: '5 min read',
    date: 'Jan 5, 2026',
